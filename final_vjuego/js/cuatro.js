...
var game = new Phaser.Game(810, 2000, Phaser.AUTO,'',{preload:preload, create, update:update});
...
function preload(){
    ...
    game.load.image('fondo', 'imagenes/labespacio.png');
...
function create(){
    ...
    fondo = game.add.tileSprite(0,0, 2048,2024, 'fondo');

    // Colocar el heroe en el escenario
    player = game.add.sprite(game.width/6,game.height/3.1,'astronauta');
